...
int tagPS[NO], tagFS[NO], tagHS[NO], failed[NN];
int mark[NO], mark_zyg[NN], mark_zygb[NO], mark_zygo[NO];
int fathero[NO], mothero[NO], tagPSo[NO], tagFSo[NO], tagHSo[NO];
int ss, SNP[MM][31];

double genval_sf[NN], genval_sv[NN], pm_sf[NN], pm_sv[NN], pm_sfb[NO], pm_svb[NO];
double genval_at[NN], pm_at[NN], pm_atb[NO], VE;
